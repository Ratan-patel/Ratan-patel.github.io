# Ratan OS and Ratan AI Promotion Kit
...
These phrases should be used naturally in headings, descriptions and helpful explanations. Keyword stuffing, fake ranking claims and guaranteed Google placement should be avoided.
...
| Google Search / Search Console | Discovery channel, not a marketplace | Index the release page, sitemap and helpful documentation | No ranking or traffic guarantee; account verification is required |
| Social channels | Awareness channel | Publish the ready post with the official release URL | Avoid automated spam, fake engagement and unapproved posting |

## Compliance copy for any paid listing

Ratan OS is a downloadable Debian-based training and assessment environment intended solely for systems and networks covered by explicit written authorization. The buyer is responsible for lawful use, scope, rate limits, stop conditions and applicable law. The package does not provide access to third-party systems, credentials, malware, stealth/persistence, data exfiltration or destructive services. Optional setup support from INR 799 covers the confirmed deliverables only; it does not authorize testing of any target.
...
3. [Lemon Squeezy prohibited products](https://docs.lemonsqueezy.com/help/getting-started/prohibited-products)
4. [Paddle acceptable-use guidance](https://www.paddle.com/help/start/intro-to-paddle/what-am-i-not-allowed-to-sell-on-paddle)
5. [Gumroad prohibited products](https://gumroad.com/prohibited)
